...
<h1 style="color:#3EC28F;font-size:165%;">Integration Config</h1>

<hr />

<label>
     <p style="width:100%;padding-left:10px" id="team">Team name:</p>
    <p style="width:100%;padding-left:10px" id="project">Project name:</p>
</label>

<hr />

<label class="row">
    <span>Available localization version(s)</span>
    <select id="localizations" class="localizations">
        <option value="none" selected="selected"> Select </option>
    </select>
</label>

<label class="row" style="padding-left:20px;">
...
<label class="row">
    <span>Available image version(s)</span>
    <select id="images" class="images">
    <option value="none" selected="selected"> Select </option>
    </select>
</label>

<label class="row">
    <span>Available color version(s)</span>
...
<label class="row">
    <span>Available appicon version(s)</span>
    <select id="appicons" class="appicons">
    <option value="none" selected="selected"> Select </option>
    </select>
</label>
...
<footer>
    ...
    <button type="submit" uxp-variant="cta" autofocus>Next</button>
</footer>
