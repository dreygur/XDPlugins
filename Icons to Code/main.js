...
/***/ "./node_modules/css-loader/index.js!./src/components/Dialog.css":
/*!*************************************************************!*\
  !*** ./node_modules/css-loader!./src/components/Dialog.css ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, ".HRoMXiZKf-l1rsTjwxy6U {\n    width: 360px;\n}\n._3mCd2S1mo9RBxB1H13vhYh {\n    align-items: center;\n    justify-content: space-between;\n    display: flex;\n    flex-direction: row;\n}\n.qQCfzqJqc6VGIC4e6hKf- {\n    border-radius: 4px;\n    width: 24px;\n    height: 24px;\n    overflow: hidden;\n}\n", ""]);

// exports
exports.locals = {
	"form": "HRoMXiZKf-l1rsTjwxy6U",
	"h1": "_3mCd2S1mo9RBxB1H13vhYh",
	"icon": "qQCfzqJqc6VGIC4e6hKf-"
};

/***/ }),

/***/ "./node_modules/css-loader/index.js!./src/components/SelectionAmount.css":
/*!**********************************************************************!*\
  !*** ./node_modules/css-loader!./src/components/SelectionAmount.css ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "._2ECiUKkL1-GJ0NOZn1xA8n {\n    flex: 1;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    height: 34px;\n    background-color: #EAEAEA;\n    border: 1px dotted rgba(0,0,0,0.05);\n    margin-top: 10px;\n    border-radius: 3px;\n}\n\n._3vKwXnRB-u52O5MowhRWjc {\n    color: #3F3F3F;\n}\n", ""]);

// exports
exports.locals = {
	"wrapper": "_2ECiUKkL1-GJ0NOZn1xA8n",
	"text": "_3vKwXnRB-u52O5MowhRWjc"
};

/***/ }),

/***/ "./node_modules/css-loader/index.js!./src/components/SubscriptionMessage.css":
/*!**************************************************************************!*\
  !*** ./node_modules/css-loader!./src/components/SubscriptionMessage.css ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "._1va-59OElOWw-vZTXFWR9w {\n    flex: 1;\n    display: flex;\n    align-items: center;\n    justify-content: flex-start;\n    min-height: 34px;\n    padding: 6px;\n    background-color: #FFD289;\n    border: 1px solid #D9A95B;\n    margin-top: 10px;\n    margin-bottom: 16px;\n    border-radius: 3px;\n}\n\n._3FJkXjMJA4q4L-svUfuMY2 {\n    flex: 1;\n    display: flex;\n    align-items: center;\n    justify-content: flex-start;\n    min-height: 34px;\n    padding: 6px;\n    background-color: #80FFD6;\n    border: 1px solid #59DDB2;\n    margin-top: 10px;\n    margin-bottom: 16px;\n    border-radius: 3px;\n}\n\n._2N1CuRJI0UEnYkl7Sq9Ig2 {\n    color: #3F3F3F;\n}\n", ""]);

// exports
exports.locals = {
	"default": "_1va-59OElOWw-vZTXFWR9w",
	"loggedIn": "_3FJkXjMJA4q4L-svUfuMY2",
	"text": "_2N1CuRJI0UEnYkl7Sq9Ig2"
};
...
const SelectAmount = __webpack_require__(/*! ./components/SelectionAmount */ "./src/components/SelectionAmount.jsx");
const SubscriptionMessage = __webpack_require__(/*! ./components/SubscriptionMessage */ "./src/components/SubscriptionMessage.jsx");
const uuid = __webpack_require__(/*! uuid-random */ "./node_modules/uuid-random/index.js");

const Dialog = __webpack_require__(/*! ./components/Dialog */ "./src/components/Dialog.jsx");
...
class App extends React.Component {
    ...
    documentStateChanged(selectionProp) {
        const { selection, Artboard } = __webpack_require__(/*! scenegraph */ "scenegraph");
        let selectedIcons = [];
    ...
    async getSvgCode(index, tmpFolder) {
        ...
        if (segmentIndex === -1) segment = { name: SEGMENT_NAME, icons: [] };else segment = codeCopy[segmentIndex];
        segment.icons.push({ name: icon.name, svg });
        if (segmentIndex === -1) codeCopy.push(segment);else codeCopy[segmentIndex] = segment;
                ...
                if (response.status === 200) {
                    ...
                    data.forEach(option => {
                        if (allowedTypes.includes(option.output_option.output_category)) {
                            if (option.output_option.file_type === 'custom' && team.custom_template && team.custom_template.validated) teamExportOptions.push(option.output_option);else if (option.output_option.file_type !== 'custom') teamExportOptions.push(option.output_option);
                        }
                    });
    ...
    async getBoards() {
        ...
        try {
            ...
            this.setState({ boards: boards.filter(board => board.type === 4) }, () => {
                if (this.state.boards.length > 0) this.setBoard(this.state.boards[0]);
            });
        } catch (error) {
    ...
    render() {
        ...
        return React.createElement(
            ...
            React.createElement(SelectAmount, { amount: selectedIcons.length }),
            React.createElement(SubscriptionMessage, { loggedIn: !!token, amount: amountLeft }),
            React.createElement(
                'label',
                { className: 'mb6' },
                'Export format'
            ...
            exportOptions.map(option => {
                ...
                return React.createElement(
                    'label',
                    { onClick: () => this.setState({ checkedFileType: value }), key: `export-option-${option.file_type}`, className: 'row' },
                    React.createElement('input', { checked: checkedFileType === option.file_type || checkedFileType === option.file_type + '_' + team, onChange: () => this.setState({ checkedFileType: option.file_type }), type: 'radio', name: 'export-option' }),
                    React.createElement(
                        'span',
                        null,
                        React.createElement(
                            'div',
                            null,
                            React.createElement('img', { src: `https://sugarcode-assets.s3.eu-central-1.amazonaws.com/icanicon/${option.icon}` })
                        ),
                        option.name,
                        React.createElement(
                            'i',
            ...
            exportOptions.length === 0 && (freeExportOptionsLoading || teamExportOptionsLoading) && React.createElement(
                'div',
                null,
                React.createElement(
                    'span',
            ...
            React.createElement(
                ...
                React.createElement(
                    'button',
                    { disabled: exportLoading, onClick: this.exportIcons, 'uxp-variant': 'cta' },
            ...
            !token && React.createElement(
                ...
                React.createElement(
                    'label',
                    { className: 'mb6' },
                    'Login to your icanicon.io account'
                ),
                React.createElement(
                    'label',
                    { className: 'input-row' },
                    ...
                    React.createElement('input', { onChange: e => this.setState({ username: e.target.value }), type: 'text', placeholder: 'Enter your email' })
                ),
                React.createElement(
                    'label',
                    { className: 'input-row' },
                    ...
                    React.createElement('input', { onChange: e => this.setState({ password: e.target.value }), type: 'password', placeholder: 'Enter your password' })
                ),
                React.createElement(
                    'div',
                    { className: 'row-center' },
                    React.createElement(
                        'a',
                        { href: 'https://icanicon.io/forgot-password' },
                        'Forgot password?'
                    )
                ),
                React.createElement(
                    ...
                    React.createElement(
                        'button',
                        { disabled: loginLoading, onClick: this.login, 'uxp-variant': 'primary' },
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'a',
                        { href: 'https://icanicon.io/signup?plan=supernova' },
                        'Sign up'
                    )
                )
            ),
            token && React.createElement(
                ...
                !teamsLoading && teams.length > 0 && React.createElement(
                    'select',
                    { defaultValue: teams[0], onChange: e => {
                            const selectedTeam = e.target.value;
                            this.selectTeam(teams[selectedTeam]);
                        } },
                    teams.map((t, index) => React.createElement(
                        'option',
                        { value: index, key: `select-team-${index}` },
                        t.name
                    ))
                ),
                teamsLoading && React.createElement(
                    'div',
                    null,
                    React.createElement(
                        'span',
            ...
            token && React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'button',
                        { disabled: logoutLoading, onClick: this.logout, 'uxp-variant': 'primary' },
...
var content = __webpack_require__(/*! !../../node_modules/css-loader!./Dialog.css */ "./node_modules/css-loader/index.js!./src/components/Dialog.css");
...
const React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
const styles = __webpack_require__(/*! ./Dialog.css */ "./src/components/Dialog.css");
...
class Dialog extends React.Component {
    ...
    render() {
        return React.createElement(
            ...
            React.createElement(
                "form",
                { className: styles.form, method: "error-alert" },
                React.createElement(
                    "h1",
                    { className: styles.h1, style: this.props.isError ? { color: '#C74545' } : { color: 'initial' } },
                    React.createElement(
                        "span",
                        null,
                        this.props.title
                    ),
                    React.createElement("img", { className: styles.icon, src: "https://sugarcode-assets.s3.eu-central-1.amazonaws.com/icanicon/ii-icon.svg" })
                ),
                React.createElement("hr", null),
                React.createElement(
                    "p",
                ...
                React.createElement(
                    ...
                    React.createElement(
                        "button",
                        { onClick: () => this.myDialog && this.myDialog.current.close(), "uxp-variant": "primary" },
                        "Got it"
                    )
                )
            )
...
/***/ "./src/components/SelectionAmount.css":
/*!********************************************!*\
  !*** ./src/components/SelectionAmount.css ***!
  \********************************************/
/*! no static exports found */
...
var content = __webpack_require__(/*! !../../node_modules/css-loader!./SelectionAmount.css */ "./node_modules/css-loader/index.js!./src/components/SelectionAmount.css");
...
/***/ "./src/components/SelectionAmount.jsx":
/*!********************************************!*\
  !*** ./src/components/SelectionAmount.jsx ***!
  \********************************************/
/*! no static exports found */
...
const React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
const styles = __webpack_require__(/*! ./SelectionAmount.css */ "./src/components/SelectionAmount.css");

const SelectionAmount = ({ amount } = {}) => React.createElement(
    "div",
...
/***/ "./src/components/SubscriptionMessage.css":
/*!************************************************!*\
  !*** ./src/components/SubscriptionMessage.css ***!
  \************************************************/
/*! no static exports found */
...
var content = __webpack_require__(/*! !../../node_modules/css-loader!./SubscriptionMessage.css */ "./node_modules/css-loader/index.js!./src/components/SubscriptionMessage.css");
...
/***/ "./src/components/SubscriptionMessage.jsx":
/*!************************************************!*\
  !*** ./src/components/SubscriptionMessage.jsx ***!
  \************************************************/
/*! no static exports found */
...
const React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
const styles = __webpack_require__(/*! ./SubscriptionMessage.css */ "./src/components/SubscriptionMessage.css");

const SubscriptionMessage = ({ loggedIn, amount } = {}) => React.createElement(
    "div",
    { className: !loggedIn ? styles.default : styles.loggedIn },
