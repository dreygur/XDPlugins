  ...
  render() {
    return React.createElement(
      ...
      React.createElement(
        "p",
        null,
        "Use the premade people illustrations or mix-&-match illustrations to create your own unique work."
      ),
      React.createElement(
        "p",
        { className: "tkmadeit" },
        ...
        React.createElement(
          "a",
          { href: "https://twitter.com/tkmadeit" },
          " @tkmadeit"
        )
      )
    );
...
const SvgInline = props => {
  ...
  React.useEffect(() => {
    fetch(props.url, { cache: "force-cache" }).then(res => {
      return res.text();
    }).then(svgText => {
      ...
      setSvg(svgText);
      setSvgMod(svgMod);
    }).catch(setIsErrored).then(() => setIsLoaded(true));
  }, [props.url]);
...
class Humaaans extends React.Component {
  ...
  render() {
    ...
    allHumaaans = humaaanList.map((humaaan, index) => {
      return React.createElement(SvgInline, {
        key: humaaan,
    ...
    return React.createElement(
      "div",
      { className: "all-humaaans" },
      allHumaaans.length > 0 ? allHumaaans : React.createElement(
        "span",
        { className: "no-result" },
        "No search result."
      )
...
const App = __webpack_require__(/*! ./ui.jsx */ "./src/ui.jsx");
...
var content = __webpack_require__(/*! !../node_modules/css-loader!./ui.css */ "./node_modules/css-loader/index.js!./src/ui.css");
...
const stylesme = __webpack_require__(/*! ./ui.css */ "./src/ui.css");
const Credit = __webpack_require__(/*! ./Credit.jsx */ "./src/Credit.jsx");
const AllHumaaanList = ["sitting-1", "sitting-2", "sitting-3", "sitting-4", "sitting-5", "sitting-6", "sitting-7", "sitting-8", "standing-1", "standing-2", "standing-3", "standing-4", "standing-5", "standing-6", "standing-7", "standing-8", "standing-9", "standing-10", "standing-11", "standing-12", "standing-13", "standing-14", "standing-15", "standing-16", "standing-17", "standing-18", "standing-19", "standing-20", "standing-21", "standing-22", "standing-23", "standing-24", "accessoriesShoeFlatPointy", "accessoriesShoeFlatSimple", "accessoriesShoeFlatSneaker", "bodyHoodie", "bodyJacket", "bodyJacket2", "bodyLabCoat", "bodyLongSleeve", "bodyPointingForward", "bodyPointingUp", "bodyPregnant", "bodyTrenchCoat", "bodyTurtleNeck", "bottomSittingBaggyPants", "bottomSittingSkinnyJeans1", "bottomSittingSweatPants", "bottomStandingBaggyPants", "bottomStandingJogging", "bottomStandingShorts", "bottomStandingSkinnyJeans", "bottomStandingSkinnyJeansWalk", "bottomStandingSkirt", "bottomStandingSprint", "bottomStandingSweatpants", "headFrontAfro", "headFrontAiry", "headFrontCaesar", "headFrontChongo", "headFrontCurly", "headFrontHijab2", "headFrontHijab1", "headFrontLong", "headFrontNoHair", "headFrontPony", "headFrontRad", "headFrontShort1", "headFrontShort2", "headFrontShortBeard", "headFrontTop", "headFrontTurban2", "headFrontTurban1", "headFrontWavy", "objectsSeatBall", "objectsSeatCube", "objectsSeatCube2", "sceneHomePlant", "sceneHomeTable", "sceneHomeBigLeafPlant", "sceneHomeLamp", "sceneHomeHangingLamp", "sceneHomeClock", "scenePlantTopLeaves", "scenePlantMaceta", "scenePlantPlantLeft", "scenePlantPlantRight"];
...
const SuccessScreen = ({ dialog, backToIllustrations }) => {
  return React.createElement(
    ...
    React.createElement(
      "h1",
      null,
      "Illustration copied to your clipboard! \uD83C\uDF89"
    ),
    React.createElement(
      "div",
      ...
      React.createElement(
        "button",
        { "uxp-variant": "primary", onClick: () => backToIllustrations() },
        "Back to illustrations"
      )
    )
  );
};
const Humaaans = __webpack_require__(/*! ./Humaaans.jsx */ "./src/Humaaans.jsx");
  ...
  constructor(props) {
    ...
    this.filterHumaaans = event => {
      ...
      let filteredHumaaans = humaaanList.filter(humaaan => {
        return humaaan.toLocaleLowerCase().indexOf(searchTerm.toLocaleLowerCase()) >= 0;
      });
      if (!searchTerm) {
